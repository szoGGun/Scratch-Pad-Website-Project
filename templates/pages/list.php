<div class="list">
            ...
            <div class="tbl-content">
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php foreach ($params['notes'] ?? [] as $notes): ?>
                        <?php if ($notes['usersID'] == $_SESSION["user_login"]): ?>
                            <tr>

                                <td><?php echo $notes['id'] ?></td>
                                <td><?php echo $notes['title'] ?></td>
                                <td><?php echo $notes['created'] ?></td>
                                <td>
                                    <a href="/?action=show&id=<?php echo $notes['id'] ?>">
                                        <button>Show details</button>
                                    </a>
                                    <a href="/?action=delete&id=<?php echo $notes['id'] ?>">
    ...
    <?php else: ?>
        <h1 class="headertekst">Please log in<h1>
    <?php endif; ?>
</div>
